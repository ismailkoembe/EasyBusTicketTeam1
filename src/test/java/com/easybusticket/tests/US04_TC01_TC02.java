...
import static com.easybusticket.pages.BasePage.wait;

@Slf4j
public class US04_TC01_TC02 extends BaseTest {
    ...
    public void footerAndItemsVisibilityTest() {
        ...
        homePage.footerSocialMediaIkons.isDisplayed();
        ...
        homePage.getContactTitleFooter.isDisplayed();
        ...
        homePage.footerContactInfo.isDisplayed();
